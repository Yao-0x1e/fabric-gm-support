...
import (
	...
	"github.com/gxnublockchain/gmsupport/internal/x/net/http2/hpack"
...
func (b http2transportResponseBody) Read(p []byte) (n int, err error) {
	...
	if cs.bytesRemain != -1 {
		if int64(n) > cs.bytesRemain {
			...
			if err == nil {
				err = errors.New("github.com/gxnublockchain/gmsupport/net/http: server replied with more than declared Content-Length; truncated")
